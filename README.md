...
2. Segui il flusso a step:
   ...
   - **Inserimento dati**: tab "Peso & bici" (peso atleta, bici o selezione da catalogo con peso precompilato, tipologia) e tab "Dati salita" (dislivello/pendenza, distanza, tempo hh:mm:ss, vento opzionale, nome/data scalata, pulsante "Disegna il percorso" per tracciare su mappa e autocompilare distanza e dislivello stimato).
